...
<body class="dashboard-body">
    ...
    <div class="app-shell admin-shell">
        ...
        <aside class="admin-sidebar">
            ...
            <nav class="admin-nav">
                ...
                <div class="admin-nav-section">
                    ...
                    <div
                        class="admin-nav-group {{ request()->routeIs('admin.about.*', 'admin.about-sections.*', 'admin.about-section3.*', 'admin.about-milestones.*', 'admin.about-section4-items.*', 'admin.about-section4-pages.*') ? 'open' : '' }}">
                        <button type="button"
                            class="admin-nav-link admin-nav-toggle {{ request()->routeIs('admin.about.*', 'admin.about-sections.*', 'admin.about-section3.*', 'admin.about-milestones.*', 'admin.about-section4-items.*', 'admin.about-section4-pages.*') ? 'active' : '' }}"
                ...
                <div class="admin-nav-section">
                    ...
                    <div
                        class="admin-nav-group {{ request()->routeIs('admin.blog*', 'admin.blog-categories.*') ? 'open' : '' }}">
                        <button type="button"
                            class="admin-nav-link admin-nav-toggle {{ request()->routeIs('admin.blog*', 'admin.blog-categories.*') ? 'active' : '' }}"
                            onclick="toggleNavGroup(this)">
                            <svg viewBox="0 0 24 24" stroke-width="2">
                    ...
                    <div
                        class="admin-nav-group {{ request()->routeIs('admin.careers*', 'admin.career-applicants.*') ? 'open' : '' }}">
                        <button type="button"
                            class="admin-nav-link admin-nav-toggle {{ request()->routeIs('admin.careers*', 'admin.career-applicants.*') ? 'active' : '' }}"
                            onclick="toggleNavGroup(this)">
                            <svg viewBox="0 0 24 24" stroke-width="2">
                ...
                <div class="admin-nav-section">
                    ...
                    <div
                        class="admin-nav-group {{ request()->routeIs('admin.clients*', 'admin.client-categories.*') ? 'open' : '' }}">
                        <button type="button"
                            class="admin-nav-link admin-nav-toggle {{ request()->routeIs('admin.clients*', 'admin.client-categories.*') ? 'active' : '' }}"
                            onclick="toggleNavGroup(this)">
                            <svg viewBox="0 0 24 24" stroke-width="2">
                                <rect x="3" y="3" width="18" height="18" rx="2" />
                                <path d="M3 9h18" />
        ...
        <div class="admin-main">
            ...
            @if (session('success'))
                <div
                    style="margin:16px 24px -8px;padding:10px 16px;background:#dcfce7;border:1px solid #86efac;border-radius:10px;font-size:13px;color:#166534;">
                    {{ session('success') }}
                </div>
            @endif
            ...
            @if (session('error'))
                <div
                    style="margin:16px 24px -8px;padding:10px 16px;background:#fee2e2;border:1px solid #fca5a5;border-radius:10px;font-size:13px;color:#991b1b;">
                    {{ session('error') }}
                </div>
            @endif
