      ...
      <div class="contact-grid">
        ...
        <div class="rv">
          ...
          @if($contact?->latitude && $contact?->longitude)
            <a href="https://maps.google.com/maps?q={{ $contact->latitude }},{{ $contact->longitude }}" target="_blank" rel="noopener" class="contact-map-link">
          @endif
      ...
      <div class="footer-grid">
        ...
        <div class="footer-col">
          ...
          <ul>
            ...
            <li><a href="mailto:{{ $contact?->email ?: 'hello@ercommunication.id' }}">{{ $contact?->email ?: 'hello@ercommunication.id' }}</a></li>
          </ul>
        </div>
      </div>
