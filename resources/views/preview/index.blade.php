...
============================================================ */
    ...
    .b1 {
      width: 18%;
      height: 88%;
      background: linear-gradient(to top, #1a2a3a, #0e1824);
      border-top: 2px solid rgba(0, 194, 168, .3);
      display: grid;
    ...
    .b2 {
      width: 22%;
      height: 100%;
      background: linear-gradient(to top, #223040, #0f1e2e);
      border-top: 2px solid rgba(0, 194, 168, .4);
      display: grid;
    ...
    .b2 span:nth-child(4n+1) {
      background: rgba(0, 194, 168, .2)
    }

    .b2 span:nth-child(4n+2) {
    ...
    .b3 {
      width: 16%;
      height: 75%;
      background: linear-gradient(to top, #182030, #0c1522);
      border-top: 2px solid rgba(0, 194, 168, .2)
    }

    .b4 {
      width: 14%;
      height: 60%;
      background: linear-gradient(to top, #1e2c3e, #111e2c);
...
============================================================ */
    ...
    .ph-1 {
      background: linear-gradient(135deg, #1a2535 0%, #2a3a50 50%, #1a2535 100%)
    }

    .ph-2 {
      background: linear-gradient(135deg, #0e1825 0%, #1e3040 60%, #0e1825 100%)
    }

    .ph-3 {
      background: linear-gradient(155deg, #1a1e2a 0%, #2a2e3e 50%, #141820 100%)
    }

    .ph-4 {
      background: linear-gradient(135deg, #101820 0%, #182838 55%, #101820 100%)
    }

    .ph-5 {
      background: linear-gradient(145deg, #0c1520 0%, #162030 60%, #0c1520 100%)
    }

    .ph-6 {
      background: linear-gradient(135deg, #141822 0%, #1e2838 50%, #141822 100%)
    }
...
============================================================ */
    ...
    .nstat-av:first-child {
      margin-left: 0
    }

    .av-a {
      background: linear-gradient(135deg, #e8622a, #c0392b)
    }
...
============================================================ */
    ...
    .pt-1 {
      background: linear-gradient(135deg, #1a2535, #2a3a55)
    }
    ...
    .pt-3 {
      background: linear-gradient(135deg, #151e2e, #1e2840)
    }
...
============================================================ */
    ...
    >>>>>>>70d7b3b036b9e13a044b3391aad794dc6fa88974 .footer-grid {
      display: grid;
      grid-template-columns: 1.4fr 1fr 1fr 1fr;
      gap: 48px;
      margin-bottom: 48px;
...
<body>
  ...
  <!-- ===================== HERO ===================== -->
  <section id="hero">
    <div class="hero-photo" @if($hero->background_image)
      style="background-image:url('{{ Storage::url($hero->background_image) }}');background-size:cover;background-position:center"
    @endif></div>
    ...
    <div class="wrap">
      <div class="about-grid">
        ...
        <div class="rv">
          ...
          <div class="s-body">
            {!! $about->description ?: 'ER Communication is one of leading agency in Indonesia and we specialize in consumer lifestyle. We combine strategy, creativity, and media intelligence to deliver campaigns that truly resonate.' !!}
          </div>
        ...
        <div class="rv rv2">
          <div class="img-grid">
            <!-- col 1 -->
            <div class="img-col">
              <div class="img-thumb tall ph-1" @if($about->background_image)
                style="background-image:url('{{ Storage::url($about->background_image) }}');background-size:cover;background-position:center"
              @endif></div>
    ...
    <div class="wrap">
      <div class="narr-inner">
        ...
        <div class="rv">
          ...
          <p class="narr-text">
            Whether it's media relations, public communication or brand strategy, we help organizations communicate with
            <strong>clarity, trust, credibility, confidence</strong> in a fast-moving world.<br /><br />
            ...
            <div style="display:grid;grid-template-columns:repeat(4,1fr);border-bottom:1px solid var(--border)">
              @forelse($stats as $i => $stat)
                <div class="nstat" @if($i > 0) style="border-left:1px solid var(--border)" @endif>
                  <div class="nstat-num" @if(is_numeric($stat->stat_number))
                  style="display:flex;align-items:baseline;gap:4px" @endif>
    ...
    <div class="wrap">
      <div class="partners-layout">
        ...
        <div class="rv">
          ...
          <p class="s-body" style="max-width:260px">Always delivering top-quality services at all times. Deliver on our
            growing experience and skill-level.</p>
        ...
        <div class="rv">
          ...
          <div class="team-feature-photo">
              ...
              @else
                <div class="team-photo-bg">
                  ...
                  <svg viewBox="0 0 280 380" width="100%" style="position:absolute;inset:0;z-index:1">
                    ...
                    <!-- glasses -->
                    <rect x="112" y="168" width="26" height="18" rx="8" fill="none" stroke="rgba(255,255,255,0.4)"
                      stroke-width="2" />
                    <rect x="142" y="168" width="26" height="18" rx="8" fill="none" stroke="rgba(255,255,255,0.4)"
                      stroke-width="2" />
                    <line x1="138" y1="177" x2="142" y2="177" stroke="rgba(255,255,255,0.4)" stroke-width="1.5" />
                    <!-- smile -->
                    <path d="M 126 194 Q 140 206 154 194" fill="none" stroke="rgba(255,255,255,0.5)" stroke-width="2"
            ...
            <div class="team-feature-desc">
              Always the perfect solution with the right team at your side at all times. Deliver on our growing
              experience and skill-set.
            </div>
            <div style="display:flex;gap:10px;margin-top:4px">
              <a href="#contact"
                style="display:inline-flex;align-items:center;gap:6px;padding:9px 20px;border-radius:6px;background:var(--teal);color:#fff;font-size:13px;font-weight:700;transition:opacity .2s">
                Get in Touch
              </a>
            </div>
        ...
        <div class="rv rv2">
          <div style="padding-top:12px">
            ...
            <p style="font-size:14px;color:var(--muted);line-height:1.75;max-width:380px;margin-bottom:28px">
              {{ $teamSetting->subheadline ?: 'Always delivering the perfect solution with the right team at your side at all times. Every campaign is led by a dedicated expert who understands your brand and audience.' }}
            </p>
            ...
            <!-- stats below -->
            <div
              style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:40px;padding-top:40px;border-top:1px solid var(--border)">
              <div>
                <div style="font-family:var(--serif);font-size:36px;color:var(--white);line-height:1">24<span
                    style="color:var(--orange)">+</span></div>
                <div style="font-size:13px;color:var(--muted);margin-top:4px">Expert Consultants</div>
              </div>
              <div>
                <div style="font-family:var(--serif);font-size:36px;color:var(--white);line-height:1">12<span
                    style="color:var(--orange)">+</span></div>
                <div style="font-size:13px;color:var(--muted);margin-top:4px">Years Experience</div>
              </div>
              <div>
                <div style="font-family:var(--serif);font-size:36px;color:var(--white);line-height:1">500<span
                    style="color:var(--orange)">+</span></div>
                <div style="font-size:13px;color:var(--muted);margin-top:4px">Projects Delivered</div>
              </div>
              <div>
                <div style="font-family:var(--serif);font-size:36px;color:var(--white);line-height:1">98<span
                    style="color:var(--orange)">%</span></div>
          ...
          <div class="port-card rv {{ $i === 1 ? 'rv2' : ($i === 2 ? 'rv3' : '') }}">
            <div class="port-thumb pt-{{ ($i % 3) + 1 }}">
              @if($portfolio->cover_image)
                <img src="{{ Storage::url($portfolio->cover_image) }}" alt="{{ $portfolio->project_title }}"
                  style="position:absolute;inset:0;width:100%;height:100%;z-index:0" />
              @else
                <div class="port-thumb-icon">{{ ['📰', '🎤', '📱'][$i % 3] }}</div>
              @endif
              @if($portfolio->category)
                <div class="port-badge" @if($i === 1) style="background:rgba(59,130,246,.9)" @elseif($i === 2)
                style="background:rgba(0,194,168,.9)" @endif>{{ $portfolio->category->name }}</div>
              @endif
            </div>
            <div class="port-body">
              ...
              @endif
              <a href="{{ $portfolio->project_url ?: '#contact' }}" class="port-link" @if($portfolio->project_url)
        ...
        @empty
          <div class="port-card rv">
            ...
            <div class="port-body">
              ...
              <p class="port-desc">We provide top-notch media relations and is usually personified by the client. Doing
                sound-strategy.</p>
          ...
          <div class="port-card rv rv3">
            ...
            <div class="port-body">
              ...
              <p class="port-desc">We push boundaries through a unique experience. We build a company that's true in
                communications.</p>
              <a href="#contact" class="port-link">
                See More
                <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
      ...
      <div class="cta-banner-inner">
        <div class="cta-banner-left rv">
          ...
          <p class="cta-banner-sub">
            {{ $ctaBanner->subtext ?: 'Tell us about your brand and goals — our strategists will get back to you within one business day with a tailored approach.' }}
          </p>
    ...
    <div class="wrap">
      <div class="contact-grid">
        ...
        <div class="rv">
          ...
          <p>If you require assistance with PR matters but would like to speak with the appropriate team, please do not
            hesitate to fill this form and check stocks and company details.</p>

          <!-- Map -->
          @if($contact?->latitude && $contact?->longitude)
            <a href="https://maps.google.com/maps?q={{ $contact->latitude }},{{ $contact->longitude }}" target="_blank"
              rel="noopener" class="contact-map-link">
          @endif
            <div class="contact-map">
              ...
              <div class="map-pin">
                ...
                <div class="map-pin-label">
                  {{ $contact?->address ? \Illuminate\Support\Str::limit($contact->address, 30) : 'ER Communication, Jakarta' }}
                </div>
              </div>
            </div>
            @if($contact?->latitude && $contact?->longitude)
          ...
          <div class="contact-details">
            <div class="cd-item">
              ...
              <span>{{ $contact?->address ?: '123 PR Avenue, Block A' }}</span>
            </div>
            <div class="cd-item">
              <div class="cd-icon">✉</div>
              <span>{{ $contact?->email ?: 'hello@ercommunication.id' }}</span>
            </div>
            <div class="cd-item">
              <div class="cd-icon">📞</div>
              <span>{{ $contact?->phone ?: '+62 21 5000 8888' }}</span>
            </div>
          </div>
        </div>
      ...
      <div class="footer-grid">
        ...
        <div>
          <div class="footer-logo">
            @if($navbar->logo_light || $navbar->logo_dark)
              <img src="{{ Storage::url($navbar->logo_light ?: $navbar->logo_dark) }}" alt="Logo"
                style="height:32px;width:auto" />
            @else
              ER<span class="dot"></span>
            @endif
          </div>
          <p class="footer-desc">PR &amp; Strategic Communication Agency that helps brands speak with clarity, trust,
            and lasting impact.</p>
          <div class="footer-socials">
            @forelse(($footer->social_media ?? []) as $social)
              <a href="{{ $social['url'] ?? '#' }}" target="_blank" rel="noopener"
                class="fs-btn">{{ $social['icon'] ?? ($social['label'] ?? '🔗') }}</a>
            @empty
        ...
        <div class="footer-col">
          ...
          <ul>
            ...
            <li><a href="mailto:{{ $contact?->email ?: 'hello@ercommunication.id' }}">{{ $contact?->email ?:
                'hello@ercommunication.id' }}</a></li>
          </ul>
        </div>
      </div>
  ...
  @endphp
  <a href="https://wa.me/{{ $waNumber }}" target="_blank" rel="noopener" class="wa-float"
    title="Chat via WhatsApp">💬</a>
...
=======
    ...
    document.querySelectorAll('a[href^="#"]').forEach(a => {
      a.addEventListener('click', e => {
        ...
        >>>>>>> 70d7b3b036b9e13a044b3391aad794dc6fa88974
    });
  </script>
