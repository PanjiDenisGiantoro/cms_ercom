    ...
    <div class="cms-card">
        ...
        <div class="cms-form-row" style="margin-top:14px">
            <div class="cms-field">
                ...
                <input type="text" inputmode="decimal" id="contact-lat" name="latitude" value="{{ old('latitude') }}" class="cms-input" placeholder="-6.2088000">
                @error('latitude')<span class="cms-error">{{ $message }}</span>@enderror
            </div>
            <div class="cms-field">
                <label class="cms-label">Longitude</label>
                <input type="text" inputmode="decimal" id="contact-lng" name="longitude" value="{{ old('longitude') }}" class="cms-input" placeholder="106.8456000">
