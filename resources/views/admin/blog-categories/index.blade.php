...
@section('breadcrumb', 'Content / Blog / Kategori')

@section('topbar-actions')
    <a href="{{ route('admin.blog.index') }}" class="cms-btn">Kembali</a>
    <a href="{{ route('admin.blog-categories.create') }}" class="cms-btn cms-btn-primary">+ Tambah</a>
@endsection
            ...
            @forelse($categories as $category)
                <tr>
                    ...
                    <td class="cms-actions">
                        <a href="{{ route('admin.blog-categories.edit', $category) }}" class="cms-btn cms-btn-sm">Edit</a>
                        <form method="POST" action="{{ route('admin.blog-categories.destroy', $category) }}" onsubmit="return confirm('Hapus kategori ini?')">
                            @csrf @method('DELETE')
