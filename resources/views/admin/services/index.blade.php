            ...
            <tbody>
                @forelse($categories as $category)
                    <tr>
                        ...
                        <td><span
                                class="cms-badge {{ $category->is_active ? 'cms-badge-green' : 'cms-badge-gray' }}">{{ $category->is_active ? 'Aktif' : 'Non-aktif' }}</span>
                        </td>
                        ...
                        <td class="cms-actions">
                            ...
                            <form method="POST" action="{{ route('admin.services.destroy', $category) }}"
                ...
                @empty
                    <tr>
                        <td colspan="7" class="cms-empty">Belum ada kategori layanan.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
