...
@section('title', 'Edit Kategori Client')
@section('page-title', 'Edit Kategori Client')
@section('breadcrumb', 'Social Proof / Client / Kategori / Edit')
...
@section('content')
<form id="client-category-form" method="POST" action="{{ route('admin.client-categories.update', $category) }}">
    @csrf @method('PUT')
    <div class="cms-card">
