...
@section('page-title', 'Tambah Page')
@section('breadcrumb', 'Settings / About / Section 4 / Page / Tambah')
...
@section('content')
<form id="section4-page-form" method="POST" action="{{ route('admin.about-section4-pages.store') }}">
    @csrf
    <div class="cms-card">
